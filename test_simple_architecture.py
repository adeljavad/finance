"""
تست ساده معماری ارتقاء یافته - بدون وابستگی به Django
"""
...
def test_greeting_tool_direct():
    """تست مستقیم ابزار احوال‌پرسی"""
    
    print("🧪 تست مستقیم ابزار احوال‌پرسی...")
    
    # import مستقیم بدون وابستگی به Django
...
def test_response_models_direct():
    """تست مستقیم مدل‌های پاسخ"""
    
    print("\n\n🏭 تست مستقیم مدل‌های پاسخ...")
    
    # import مستقیم
    from financial_system.models.response_models import RouterDecision, ResponseFactory, ResponseType
...
def test_router_logic():
    ...
    from financial_system.models.response_models import RouterDecision
...
def main():
    ...
    print("🚀 شروع تست ساده معماری ارتقاء یافته")
    print("=" * 60)
    
    # تست ابزار احوال‌پرسی
    test_greeting_tool_direct()
    
    # تست مدل‌های پاسخ
    test_response_models_direct()
